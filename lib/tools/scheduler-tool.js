...
/**
 * The SchedulerTool class
 * This class is used to handle the scheduler tool
 */
class SchedulerTool {
    /**
     * Constructor for the SchedulerTool
     *
    ...
    /**
     * Initializes the cron jobs for the scheduler tool
     *
     * @example
     * await schedulerTool.initCronJobs();
     */
    async initCronJobs() {
    ...
    /**
     * Gets all cron jobs for the scheduler tool
     *
    ...
    /**
     * Creates a cron job for the scheduler tool
     *
    ...
    /**
     * Deletes a cron job for the scheduler tool
     *
     * @param objectId - The object id
     * @returns - Nothing
     */
    ...
    /**
     * Start a request for the scheduler tool
     *
     * @param prompt - The prompt for the request
     * @returns - The response of the tool
     */
    ...
    /**
     * Constructs the tool message for the scheduler tool
     *
     * @param prompt - The prompt for the tool message
    ...
    /**
     * Handles the response for the scheduler tool
     *
